...
public class LichSuXuatNhapKhoService {
	...
	public ResponseEntity<Object> findByKho(int id) {
		Optional<Kho> kho = khoRepo.findById(id);
		if(kho.isEmpty()) {
			return new ResponseEntity<>("Không tìm thấy mã sản phẩm", HttpStatus.NOT_FOUND);
		}
